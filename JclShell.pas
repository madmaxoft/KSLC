...
{$ELSE}
    FullPath := ExpandFileNameUTF8(FileName);
{$ENDIF}
...
{$ELSE}
  if (LocExt = '.ico') and (FileExistsUTF8(Link.IconLocation)) then
{$ENDIF}
  begin
...
{$ELSE}
    if FileExistsUTF8(Link.Target) then
{$ENDIF}
    begin
