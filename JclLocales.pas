...
{$ELSE}
  Result := FileExistsUTF8(PathAddSeparator(GetWindowsSystemFolder) + LayoutFile);
{$ENDIF}
end;
...
{$ELSE}
  Result := ActivateKeyboardLayout(FLayout, KeybLayoutFlagsToDWORD(ActivateFlags, False));
{$ENDIF}
end;
...
{$ELSE}
  Result := ActivateKeyboardLayout(HKL_NEXT, KeybLayoutFlagsToDWORD(ActivateFlags, False));
{$ENDIF}
end;
...
{$ELSE}
  Result := ActivateKeyboardLayout(HKL_PREV, KeybLayoutFlagsToDWORD(ActivateFlags, False));
{$ENDIF}
end;
